...
export function generateMacroCSV(timeline: SimulationTimeline): string {
  const headers = [
    ...
    'Net Inflation',
    'AI GDP Contribution ($)',
    'Realized AI GDP Contribution ($)',
    'Realized AI Share of GDP',
    'AI Output Potential Share',
    'Revenue Pressure',
  ...
  const rows = timeline.years.map((y) => [
    ...
    y.macro.aiRealizedGDPContribution,
    y.macro.aiRealizedShareOfGDP,
    y.macro.aiOutputPotentialShare,
