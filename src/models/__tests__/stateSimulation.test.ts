...
function makeMockMacro(): MacroOutput {
  return {
    ...
    aiExposedInflation: 0.01,
    laborServicesInflation: 0.02,
    foodEnergyInflation: 0.023,
    nonAICompositeInflation: 0.022,
    nonAIPriceLevel: 1.0,
    laborServicesPriceLevel: 1.0,
    monetaryInflation: 0,
    unclippedConsumerTightening: 0,
    pceProxyInflation: 0.02,
    housingPipeline: 1_450_000,
    housingCompletions: 950_000,
    builderPriceIndex: 1.0,
    landResidualTarget: 1.0,
    afterTaxIncomeGrowth: 0.044,
    builderTrendGrowth: 0.037,
    creditBarLevel: 0,
    creditBarInflationExpectation: 0.026,
    housingStock: 146_600_000,
    households: 131_500_000,
    headshipRate: 0.392,
    rentIndex: 1.0,
    constructionCostIndex: 1.0,
    landCostIndex: 1.0,
    occupancyRate: 0.897,
    housingStarts: 950_000,
    incrementalCashTransfers: 0,
    inKindConsumption: 0,
    incrementalTransferSpending: 0,
    ...
    wageIndex: 1.0,
    trendWageIndex: 1.0,
    scarcityPremiumLevel: 0,
    obligationGCOLAIndex: 1.0,
